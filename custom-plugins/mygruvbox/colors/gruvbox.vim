" edited gruvbox theme - https://github.com/blinnk
" -----------------------------------------------------------------------------
" File: gruvbox.vim
...
let s:gb.dark0_hard  = ['#0D1014', 234]     " 29-32-33
let s:gb.dark0       = ['#1D2027', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#344246', 236]     " 50-48-47
let s:gb.dark1       = ['#4E5E63', 237]     " 60-56-54
let s:gb.dark2       = ['#72655E', 239]     " 80-73-69
let s:gb.dark3       = ['#756C65', 241]     " 102-92-84
let s:gb.dark4       = ['#968B84', 243]     " 124-111-100
let s:gb.dark4_256   = ['#B99781', 243]     " 124-111-100

let s:gb.gray_245    = ['#ADA59D', 245]     " 146-131-116
let s:gb.gray_244    = ['#766C62', 244]     " 146-131-116

let s:gb.light0_hard = ['#F3EDC7', 230]     " 249-245-215
...
let s:gb.bright_red     = ['#F57E70', 167]     " 251-73-52
let s:gb.bright_green   = ['#ACAE67', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#DDB24E', 214]     " 250-189-47
let s:gb.bright_blue    = ['#93AAA1', 109]     " 131-165-152
let s:gb.bright_purple  = ['#B78C98', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#87A37D', 108]     " 142-192-124
let s:gb.bright_orange  = ['#E69C5F', 208]     " 254-128-25

let s:gb.neutral_red    = ['#F57E70', 124]     " 204-36-29
let s:gb.neutral_green  = ['#A7A657', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#F1BB55', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#659092', 66]      " 69-133-136
let s:gb.neutral_purple = ['#9D667F', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#889D89', 72]      " 104-157-106
let s:gb.neutral_orange = ['#E4BBA0', 166]     " 214-93-14

let s:gb.faded_red      = ['#E08E90', 88]      " 157-0-6
let s:gb.faded_green    = ['#ACA859', 100]     " 121-116-14
let s:gb.faded_yellow   = ['#B58130', 136]     " 181-118-20
let s:gb.faded_blue     = ['#5B7E84', 24]      " 7-102-120
let s:gb.faded_purple   = ['#937688', 96]      " 143-63-113
let s:gb.faded_aqua     = ['#5D7D69', 66]      " 66-123-88
let s:gb.faded_orange   = ['#CC8B6C', 130]     " 175-58-3
